...
\node at (0.5,14.5) {$\star$};
\begin{scope}[shift={(5,8)}] %A
...
\end{scope}
\begin{scope}[shift={(10,3)},rotate=180] %L
  \fill[color=white] (0,0) rectangle (2,3);
%  \draw[color=cyan,thick] (0,0) rectangle (2,3);
  \fill[color=black] (0,2) rectangle (1,3);
  \fill[color=white] (1,2) rectangle (2,3);
...
%  \node[transform shape,color=red,anchor=west] at (2,1.5) {$\uparrow$};
\end{scope}
\begin{scope}[shift={(10,13)},rotate=-90] %E
  \fill[color=white] (0,0) rectangle (2,3);
%  \draw[color=cyan,thick] (0,0) rectangle (2,3);
  \fill[color=black] (0,2) rectangle (1,3);
  \fill[color=white] (1,2) rectangle (2,3);
...
%  \node[transform shape,color=red,anchor=west] at (2,1.5) {$\uparrow$};
\end{scope}
\begin{scope}[shift={(9,4)},rotate=90] %N
  \fill[color=white] (0,0) rectangle (2,3);
%  \draw[color=cyan,thick] (0,0) rectangle (2,3);
  \fill[color=black] (0,2) rectangle (1,3);
  \fill[color=black] (1,2) rectangle (2,3);
...
%  \fill[color=black] (0,0) rectangle (1,1);
%  \fill[color=white] (1,0) rectangle (2,1);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {6};
\end{scope}
...
%  \fill[color=black] (0,0) rectangle (1,1);
%  \fill[color=white] (1,0) rectangle (2,1);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {2};
\end{scope}
...
%  \fill[color=white] (0,0) rectangle (1,1);
%  \fill[color=white] (1,0) rectangle (2,1);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {4};
\end{scope}
...
%  \fill[color=white] (0,0) rectangle (1,1);
%  \fill[color=white] (1,0) rectangle (2,1);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {1};
\end{scope}
...
%  \fill[color=white] (0,0) rectangle (1,1);
%  \fill[color=white] (1,0) rectangle (2,1);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {3};
\end{scope}
\begin{scope}[shift={(2,1)}]
  \draw[color=black,thick] (0,0) rectangle (2,3);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {0};
\end{scope}
\begin{scope}[shift={(1,14)},rotate=-90]
  \draw[color=black,thick] (0,0) rectangle (2,3);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {5};
\end{scope}
...
\begin{scope}[shift={(14,5)},rotate=90]
  \draw[color=black,thick] (0,0) rectangle (2,3);
  \node[transform shape,color=red,anchor=west] at (2,1.5) {7};
\end{scope}
\end{tikzpicture}
\end{center}
